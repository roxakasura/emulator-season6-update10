...
public:
	...
	BYTE MoveItemToMuunInventoryFromInventory(LPOBJ lpObj, BYTE SourceSlot, BYTE TargetSlot, BYTE TargetFlag);
	BYTE MoveItemToPersonalShopFromMuunInventory(LPOBJ lpObj,BYTE SourceSlot,BYTE TargetSlot,BYTE TargetFlag);
	BYTE MoveItemToMuunInventoryFromPersonalShop(LPOBJ lpObj,BYTE SourceSlot,BYTE TargetSlot,BYTE TargetFlag);
	//
	...
	bool ChaosBoxHasItem(LPOBJ lpObj); // Fix MuEMU CashShop & Chaos Machine DUP
	bool TradeHasItem(LPOBJ lpObj); // Fix MuEMU CashShop & Chaos Machine DUP
	//Right Click
