...
public:
	...
	int m_SocketItemAcceptHarmonySwitch;
	...
	/*						*/
	int m_PetAngelDurabilityRate;
	int	m_PetSatanDurabilityRate;
	int m_PetUniriaDurabilityRate;
	int m_PetDinorantDurabilityRate;
	int m_PetDemonDurabilityRate;
	int m_PetMariaDurabilityRate;
	int m_PetRudolfDurabilityRate;
	int m_PetPandaDurabilityRate;
	int m_PetUnicornDurabilityRate;
	int m_PetSkeletonDurabilityRate;
	int m_PetHorseDurabilityRate;
	int m_PetRavenDurabilityRate;
	int m_PetFenrirDurabilityRate;
	/*						*/
	...
	int m_CastleSiegeGetCrownAssistantGuildMaster;
	...
	//REWARD CASH SHOP MASTER RESET AND EVENTITEMBAG
	int m_CommandMasterEventItemBagSwitch[MAX_ACCOUNT_LEVEL];
	int m_CommandMasterWCoinCValue[MAX_ACCOUNT_LEVEL];
	int m_CommandMasterWCoinPValue[MAX_ACCOUNT_LEVEL];
	int m_CommandMasterGoblinPointValue[MAX_ACCOUNT_LEVEL];
	//REWARD CASH SHOP RESET
	int m_CommandResetWCoinCValue[MAX_ACCOUNT_LEVEL];
	int m_CommandResetWCoinPValue[MAX_ACCOUNT_LEVEL];
	int m_CommandResetGoblinPointValue[MAX_ACCOUNT_LEVEL];
	//DL KEEP STATUS
	...
	int m_CustomItemViewEquipment[MAX_ACCOUNT_LEVEL];
	//LuckyWheel
	int LuckyWheelSwitch;
	int LuckyWheelMoney;
	//Master Reset Dinamic
	int m_DamageResetSwitch;
	int m_DamageResetPercent;
	int m_DefenseResetPercent;
	//Custom OffPVP System
	int m_CustomOffPvpLevelDisable[MAX_ACCOUNT_LEVEL];

	int GMOnMessage;
	int UserOnMessage;
	int DisableTwistingSlashDamagePVP;
	int DisablePowerSlashDamagePVP;
	int Evo3ThClass;
};
