...
bool CNpcTalk::NpcTalk(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0,gMessage.GetMessage(38));
		return 1;
	}
...
void CNpcTalk::NpcCastleSiegeCrown(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	if (gServerInfo.m_CastleSiegeGetCrownAssistantGuildMaster == 0)
	{
	...
	if (gServerInfo.m_CastleSiegeGetCrownAssistantGuildMaster == 1)
	{
