...
#pragma endregion
	...
	int MGCreateType = GetPrivateProfileInt("GameServerInfo", "MGCreateType", 0, ".\\Data\\GameServerInfo - Common.dat");

	int DLCreateType = GetPrivateProfileInt("GameServerInfo", "DLCreateType", 0, ".\\Data\\GameServerInfo - Common.dat");

#if(GAMESERVER_UPDATE>=301)

	int SUCreateType = GetPrivateProfileInt("GameServerInfo", "SUCreateType", 0, ".\\Data\\GameServerInfo - Common.dat");

#endif

#if(GAMESERVER_UPDATE>=601)

	int RFCreateType = GetPrivateProfileInt("GameServerInfo", "RFCreateType", 0, ".\\Data\\GameServerInfo - Common.dat");

#endif

	int MGCreateLevel[MAX_ACCOUNT_LEVEL];
	int DLCreateLevel[MAX_ACCOUNT_LEVEL];
	int SUCreateLevel[MAX_ACCOUNT_LEVEL];
	int RFCreateLevel[MAX_ACCOUNT_LEVEL];
	int MGCreateReset[MAX_ACCOUNT_LEVEL];
	int DLCreateReset[MAX_ACCOUNT_LEVEL];
	int SUCreateReset[MAX_ACCOUNT_LEVEL];
	int RFCreateReset[MAX_ACCOUNT_LEVEL];
	int MGCreateMasterReset[MAX_ACCOUNT_LEVEL];
	int DLCreateMasterReset[MAX_ACCOUNT_LEVEL];
	int SUCreateMasterReset[MAX_ACCOUNT_LEVEL];
	int RFCreateMasterReset[MAX_ACCOUNT_LEVEL];

	MGCreateLevel[0] = GetPrivateProfileInt("GameServerInfo", "MGCreateLevel_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateLevel[1] = GetPrivateProfileInt("GameServerInfo", "MGCreateLevel_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateLevel[2] = GetPrivateProfileInt("GameServerInfo", "MGCreateLevel_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateLevel[3] = GetPrivateProfileInt("GameServerInfo", "MGCreateLevel_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateReset[0] = GetPrivateProfileInt("GameServerInfo", "MGCreateReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateReset[1] = GetPrivateProfileInt("GameServerInfo", "MGCreateReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateReset[2] = GetPrivateProfileInt("GameServerInfo", "MGCreateReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateReset[3] = GetPrivateProfileInt("GameServerInfo", "MGCreateReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateMasterReset[0] = GetPrivateProfileInt("GameServerInfo", "MGCreateMasterReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateMasterReset[1] = GetPrivateProfileInt("GameServerInfo", "MGCreateMasterReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateMasterReset[2] = GetPrivateProfileInt("GameServerInfo", "MGCreateMasterReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	MGCreateMasterReset[3] = GetPrivateProfileInt("GameServerInfo", "MGCreateMasterReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateLevel[0] = GetPrivateProfileInt("GameServerInfo", "DLCreateLevel_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateLevel[1] = GetPrivateProfileInt("GameServerInfo", "DLCreateLevel_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateLevel[2] = GetPrivateProfileInt("GameServerInfo", "DLCreateLevel_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateLevel[3] = GetPrivateProfileInt("GameServerInfo", "DLCreateLevel_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateReset[0] = GetPrivateProfileInt("GameServerInfo", "DLCreateReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateReset[1] = GetPrivateProfileInt("GameServerInfo", "DLCreateReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateReset[2] = GetPrivateProfileInt("GameServerInfo", "DLCreateReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateReset[3] = GetPrivateProfileInt("GameServerInfo", "DLCreateReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateMasterReset[0] = GetPrivateProfileInt("GameServerInfo", "DLCreateMasterReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateMasterReset[1] = GetPrivateProfileInt("GameServerInfo", "DLCreateMasterReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateMasterReset[2] = GetPrivateProfileInt("GameServerInfo", "DLCreateMasterReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	DLCreateMasterReset[3] = GetPrivateProfileInt("GameServerInfo", "DLCreateMasterReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

#if(GAMESERVER_UPDATE>=301)

	SUCreateLevel[0] = GetPrivateProfileInt("GameServerInfo", "SUCreateLevel_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateLevel[1] = GetPrivateProfileInt("GameServerInfo", "SUCreateLevel_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateLevel[2] = GetPrivateProfileInt("GameServerInfo", "SUCreateLevel_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateLevel[3] = GetPrivateProfileInt("GameServerInfo", "SUCreateLevel_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateReset[0] = GetPrivateProfileInt("GameServerInfo", "SUCreateReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateReset[1] = GetPrivateProfileInt("GameServerInfo", "SUCreateReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateReset[2] = GetPrivateProfileInt("GameServerInfo", "SUCreateReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateReset[3] = GetPrivateProfileInt("GameServerInfo", "SUCreateReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateMasterReset[0] = GetPrivateProfileInt("GameServerInfo", "SUCreateMasterReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateMasterReset[1] = GetPrivateProfileInt("GameServerInfo", "SUCreateMasterReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateMasterReset[2] = GetPrivateProfileInt("GameServerInfo", "SUCreateMasterReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	SUCreateMasterReset[3] = GetPrivateProfileInt("GameServerInfo", "SUCreateMasterReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

#endif

#if(GAMESERVER_UPDATE>=601)

	RFCreateLevel[0] = GetPrivateProfileInt("GameServerInfo", "RFCreateLevel_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateLevel[1] = GetPrivateProfileInt("GameServerInfo", "RFCreateLevel_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateLevel[2] = GetPrivateProfileInt("GameServerInfo", "RFCreateLevel_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateLevel[3] = GetPrivateProfileInt("GameServerInfo", "RFCreateLevel_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateReset[0] = GetPrivateProfileInt("GameServerInfo", "RFCreateReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateReset[1] = GetPrivateProfileInt("GameServerInfo", "RFCreateReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateReset[2] = GetPrivateProfileInt("GameServerInfo", "RFCreateReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateReset[3] = GetPrivateProfileInt("GameServerInfo", "RFCreateReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateMasterReset[0] = GetPrivateProfileInt("GameServerInfo", "RFCreateMasterReset_AL0", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateMasterReset[1] = GetPrivateProfileInt("GameServerInfo", "RFCreateMasterReset_AL1", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateMasterReset[2] = GetPrivateProfileInt("GameServerInfo", "RFCreateMasterReset_AL2", 0, ".\\Data\\GameServerInfo - Common.dat");

	RFCreateMasterReset[3] = GetPrivateProfileInt("GameServerInfo", "RFCreateMasterReset_AL3", 0, ".\\Data\\GameServerInfo - Common.dat");

#endif

	if (MGCreateType == 0 && CharacterCreationLevel >= (WORD)MGCreateLevel[gObj[lpMsg->index].AccountLevel] && CharacterCreationReset >= (DWORD)MGCreateReset[gObj[lpMsg->index].AccountLevel] && CharacterCreationMasterReset >= (DWORD)MGCreateMasterReset[gObj[lpMsg->index].AccountLevel])
	{
		pMsg.ClassCode |= 4;
	}

	if (DLCreateType == 0 && CharacterCreationLevel >= (WORD)DLCreateLevel[gObj[lpMsg->index].AccountLevel] && CharacterCreationReset >= (DWORD)DLCreateReset[gObj[lpMsg->index].AccountLevel] && CharacterCreationMasterReset >= (DWORD)DLCreateMasterReset[gObj[lpMsg->index].AccountLevel])
	{
		pMsg.ClassCode |= 2;
	}

	if (SUCreateType == 0 && CharacterCreationLevel >= (WORD)SUCreateLevel[gObj[lpMsg->index].AccountLevel] && CharacterCreationReset >= (DWORD)SUCreateReset[gObj[lpMsg->index].AccountLevel] && CharacterCreationMasterReset >= (DWORD)SUCreateMasterReset[gObj[lpMsg->index].AccountLevel])
	{
		pMsg.ClassCode |= 1;
	}

	if (RFCreateType == 0 && CharacterCreationLevel >= (WORD)RFCreateLevel[gObj[lpMsg->index].AccountLevel] && CharacterCreationReset >= (DWORD)RFCreateReset[gObj[lpMsg->index].AccountLevel] && CharacterCreationMasterReset >= (DWORD)RFCreateMasterReset[gObj[lpMsg->index].AccountLevel])
	{
		pMsg.ClassCode |= 8;
	}
	...
	gObj[lpMsg->index].ClassFlag = ((CharacterCreationLevel >= MGCreateLevel[gObj[lpMsg->index].AccountLevel]) ? (gObj[lpMsg->index].ClassFlag | 4) : gObj[lpMsg->index].ClassFlag);

	gObj[lpMsg->index].ClassFlag = ((CharacterCreationLevel >= DLCreateLevel[gObj[lpMsg->index].AccountLevel]) ? (gObj[lpMsg->index].ClassFlag | 2) : gObj[lpMsg->index].ClassFlag);

	gObj[lpMsg->index].ClassFlag = ((CharacterCreationLevel >= SUCreateLevel[gObj[lpMsg->index].AccountLevel]) ? (gObj[lpMsg->index].ClassFlag | 1) : gObj[lpMsg->index].ClassFlag);

	gObj[lpMsg->index].ClassFlag = ((CharacterCreationLevel >= RFCreateLevel[gObj[lpMsg->index].AccountLevel]) ? (gObj[lpMsg->index].ClassFlag | 8) : gObj[lpMsg->index].ClassFlag);
...
void DGCharacterInfoRecv(SDHP_CHARACTER_INFO_RECV* lpMsg) // OK
{
	...
	if (lpObj->BlockChat == 1)
	{
		gNotice.GCNoticeSend(lpObj->Index, 1, 0, 0, 0, 0, 0, gMessage.GetMessage(887));
	}

	int GMOnMessage				= GetPrivateProfileInt("GameServerInfo","OnlineGmSwitch",0,".\\Data\\GameServerInfo - Common.dat");
	int UserOnMessage				= GetPrivateProfileInt("GameServerInfo","OnlineUserSwitch",0,".\\Data\\GameServerInfo - Common.dat");
...
void GDCharacterInfoSaveSend(int aIndex) // OK
{
	...
	//-- Banco de joyas
	for(int i = 0; i < 15; i++){pMsg.BankJewelry[i] = lpObj->BankJewelry[i];}
	//--
...
//BlockChat
void GDSaveBlocChatData(int aIndex)
{
	LPOBJ lpUser = &gObj[aIndex];

	SDHP_CHARACTER_BLOCCHAT_SEND pMsg;

	pMsg.header.set(0xD9, 0x08, sizeof(pMsg));

	memcpy(pMsg.Name, lpUser->Name, 11);

	pMsg.index = aIndex;

	pMsg.BlockChat = lpUser->BlockChat;

	gDataServerConnection.DataSend((BYTE*)&pMsg, pMsg.header.size);
}

//Info Equipment View
void GDSaveEquipmentView(int aIndex)
{
	LPOBJ lpUser = &gObj[aIndex];

	SDHP_CHARACTER_EQUIPVIEW_SEND pMsg;
	...
	pMsg.InfoEquipChar = lpUser->InfoEquipChar;
