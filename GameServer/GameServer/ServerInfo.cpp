...
void CServerInfo::ReadCommonInfo() // OK
{
	...
	{	
		gMessage.Load(gPath.GetFullPath("Lang\\Message_eng.txt"));
	}

	if (gServerInfo.m_ServerLanguage == 1)	
	{	
		gMessage.Load(gPath.GetFullPath("Lang\\Message_spn.txt"));
	}

	if (gServerInfo.m_ServerLanguage == 2)	
	{	
		gMessage.Load(gPath.GetFullPath("Lang\\Message_por.txt"));
	}
...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gPvPCoord.Load(gPath.GetFullPath("Custom\\CustomPvPCoord.txt"));
...
void CServerInfo::ReadItemInfo() // OK
{
	...
	//gItemOptionCombination.Load(gPath.GetFullPath("Item\\ItemCombinationOption.txt"));
...
void CServerInfo::ReadStartupInfo(char* section,char* path) // OK
{
	...
	GetPrivateProfileString(section,"Token","",this->m_Token,sizeof(this->m_Token),path);
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->Evo3ThClass = GetPrivateProfileInt(section,"Evo3ThClass",1,path);
	...
	this->m_CommandMasterEventItemBagSwitch[0] = GetPrivateProfileInt(section,"CommandMasterEventItemBagSwitch_AL0",0,path);

	this->m_CommandMasterEventItemBagSwitch[1] = GetPrivateProfileInt(section,"CommandMasterEventItemBagSwitch_AL1",0,path);
	
	this->m_CommandMasterEventItemBagSwitch[2] = GetPrivateProfileInt(section,"CommandMasterEventItemBagSwitch_AL2",0,path);
	
	this->m_CommandMasterEventItemBagSwitch[3] = GetPrivateProfileInt(section,"CommandMasterEventItemBagSwitch_AL3",0,path);

	this->m_CommandMasterWCoinCValue[0] = GetPrivateProfileInt(section,"CommandMasterResetWCoinCValue_AL0",0,path);

	this->m_CommandMasterWCoinCValue[1] = GetPrivateProfileInt(section,"CommandMasterResetWCoinCValue_AL1",0,path);

	this->m_CommandMasterWCoinCValue[2] = GetPrivateProfileInt(section,"CommandMasterResetWCoinCValue_AL2",0,path);

	this->m_CommandMasterWCoinCValue[3] = GetPrivateProfileInt(section,"CommandMasterResetWCoinCValue_AL3",0,path);

	this->m_CommandMasterWCoinPValue[0] = GetPrivateProfileInt(section,"CommandMasterResetWCoinPValue_AL0",0,path);

	this->m_CommandMasterWCoinPValue[1] = GetPrivateProfileInt(section,"CommandMasterResetWCoinPValue_AL1",0,path);

	this->m_CommandMasterWCoinPValue[2] = GetPrivateProfileInt(section,"CommandMasterResetWCoinPValue_AL2",0,path);

	this->m_CommandMasterWCoinPValue[3] = GetPrivateProfileInt(section,"CommandMasterResetWCoinPValue_AL3",0,path);
	
	this->m_CommandMasterGoblinPointValue[0] = GetPrivateProfileInt(section,"CommandMasterResetGoblinPointValue_AL0",0,path);

	this->m_CommandMasterGoblinPointValue[1] = GetPrivateProfileInt(section,"CommandMasterResetGoblinPointValue_AL1",0,path);

	this->m_CommandMasterGoblinPointValue[2] = GetPrivateProfileInt(section,"CommandMasterResetGoblinPointValue_AL2",0,path);

	this->m_CommandMasterGoblinPointValue[3] = GetPrivateProfileInt(section,"CommandMasterResetGoblinPointValue_AL3",0,path);

	this->m_CommandResetWCoinCValue[0] = GetPrivateProfileInt(section,"CommandResetWCoinCValue_AL0",0,path);

	this->m_CommandResetWCoinCValue[1] = GetPrivateProfileInt(section,"CommandResetWCoinCValue_AL1",0,path);

	this->m_CommandResetWCoinCValue[2] = GetPrivateProfileInt(section,"CommandResetWCoinCValue_AL2",0,path);

	this->m_CommandResetWCoinCValue[3] = GetPrivateProfileInt(section,"CommandResetWCoinCValue_AL3",0,path);

	this->m_CommandResetWCoinPValue[0] = GetPrivateProfileInt(section,"CommandResetWCoinPValue_AL0",0,path);

	this->m_CommandResetWCoinPValue[1] = GetPrivateProfileInt(section,"CommandResetWCoinPValue_AL1",0,path);

	this->m_CommandResetWCoinPValue[2] = GetPrivateProfileInt(section,"CommandResetWCoinPValue_AL2",0,path);

	this->m_CommandResetWCoinPValue[3] = GetPrivateProfileInt(section,"CommandResetWCoinPValue_AL3",0,path);
	
	this->m_CommandResetGoblinPointValue[0] = GetPrivateProfileInt(section,"CommandResetGoblinPointValue_AL0",0,path);

	this->m_CommandResetGoblinPointValue[1] = GetPrivateProfileInt(section,"CommandResetGoblinPointValue_AL1",0,path);

	this->m_CommandResetGoblinPointValue[2] = GetPrivateProfileInt(section,"CommandResetGoblinPointValue_AL2",0,path);

	this->m_CommandResetGoblinPointValue[3] = GetPrivateProfileInt(section,"CommandResetGoblinPointValue_AL3",0,path);
 ...
 //   this->m_CommandReAddSwitch				= GetPrivateProfileInt(section,"CommandReAddSwitch",0,path);
	...
	this->m_CustomOffPvpLevelDisable[0]		= GetPrivateProfileInt(section,"CustomOffPvpLevelDisable_AL0",0,path);

	this->m_CustomOffPvpLevelDisable[1]		= GetPrivateProfileInt(section,"CustomOffPvpLevelDisable_AL1",0,path);

	this->m_CustomOffPvpLevelDisable[2]		= GetPrivateProfileInt(section,"CustomOffPvpLevelDisable_AL2",0,path);

	this->m_CustomOffPvpLevelDisable[3]		= GetPrivateProfileInt(section,"CustomOffPvpLevelDisable_AL3",0,path);
}
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_NewCloseServer = GetPrivateProfileInt(section,"ServerCloseDelay",0,path);
	...
	this->m_SocketItemAcceptHarmonySwitch = GetPrivateProfileInt(section, "SocketItemAcceptHarmonySwitch", 0, path);
	...
	this->m_PkUseNPC = GetPrivateProfileInt(section,"PKUseNPC",0,path);
	...
	this->m_DuelArenaMaxScore = GetPrivateProfileInt(section,"DuelArenaMaxScore",0,path);
...
//	this->m_PetDurabilityRate = GetPrivateProfileInt(section,"PetDurabilityRate",0,path);
	...
	/*							NOVOS PETS DURABILITY											*/
	
	this->m_PetAngelDurabilityRate = GetPrivateProfileInt(section,"AngelDurabilityRate",0,path);
	
	this->m_PetSatanDurabilityRate = GetPrivateProfileInt(section,"SatanDurabilityRate",0,path);

	this->m_PetUniriaDurabilityRate = GetPrivateProfileInt(section,"UniriaDurabilityRate",0,path);

	this->m_PetDinorantDurabilityRate = GetPrivateProfileInt(section,"DinorantDurabilityRate",0,path);

	this->m_PetDemonDurabilityRate = GetPrivateProfileInt(section,"DemonDurabilityRate",0,path);

	this->m_PetMariaDurabilityRate = GetPrivateProfileInt(section,"MariaDurabilityRate",0,path);

	this->m_PetRudolfDurabilityRate = GetPrivateProfileInt(section,"RudolfDurabilityRate",0,path);

	this->m_PetPandaDurabilityRate = GetPrivateProfileInt(section,"PandaDurabilityRate",0,path);

	this->m_PetUnicornDurabilityRate = GetPrivateProfileInt(section,"UnicornDurabilityRate",0,path);

	this->m_PetSkeletonDurabilityRate = GetPrivateProfileInt(section,"SkeletonDurabilityRate",0,path);

	this->m_PetHorseDurabilityRate = GetPrivateProfileInt(section,"DarkHorseDurabilityRate",0,path);

	this->m_PetRavenDurabilityRate = GetPrivateProfileInt(section,"DarkRavenDurabilityRate",0,path); 

	this->m_PetFenrirDurabilityRate = GetPrivateProfileInt(section,"FenrirDurabilityRate",0,path);
	...
	this->m_PKDisableTrade = GetPrivateProfileInt(section,"TradeDisablePK",0,path);

	this->m_MaxLevel = GetPrivateProfileInt(section,"MaxLevelUp",0,path);
	...
	this->m_PartyRestrict = GetPrivateProfileInt(section,"PartyLevelDiferenceSwitch",0,path);

	this->m_DifferenceMaxLevelParty = GetPrivateProfileInt(section,"PartyMaxLevelDifference",0,path);
	...
	//sistema de atributos por master reset

	this->m_DamageResetSwitch = GetPrivateProfileInt(section,"DamageBonusMasterResetSwitch",0,path);

	this->m_DamageResetPercent = GetPrivateProfileInt(section,"DamageBonusMasterResetPercent",0,path);

	this->m_DefenseResetPercent = GetPrivateProfileInt(section,"DefenseBonusMasterResetPercent",0,path);
}
...
void CServerInfo::ReadCustomInfo(char* section,char* path) // OK
{
	...
	this->m_AncientAndExcellent =  GetPrivateProfileInt(section,"AncientAndExcellentSwitch",0,path);

	this->m_AncientItemTapeSwitch =  GetPrivateProfileInt(section,"AncientItemTapeSwitch",0,path);
	...
	this->m_CustomItemStartSwitch[0]	= GetPrivateProfileInt(section,"CustomStartItemSwitch_AL0",0,path);

	this->m_CustomItemStartSwitch[1]	= GetPrivateProfileInt(section,"CustomStartItemSwitch_AL1",0,path);
	
	this->m_CustomItemStartSwitch[2]	= GetPrivateProfileInt(section,"CustomStartItemSwitch_AL2",0,path);

	this->m_CustomItemStartSwitch[3]	= GetPrivateProfileInt(section,"CustomStartItemSwitch_AL3",0,path);

	this->LuckyWheelSwitch = GetPrivateProfileInt(section, "LuckyWheelSwitch", 0, path);

	this->LuckyWheelMoney = GetPrivateProfileInt(section,"LuckyWheelWcoinsValue",0,path);

	this->m_CustomItemViewEquipment[0] = GetPrivateProfileInt(section, "CustomItemViewEquipmentSwitch_AL0", 0, path);

	this->m_CustomItemViewEquipment[1] = GetPrivateProfileInt(section, "CustomItemViewEquipmentSwitch_AL1", 0, path);

	this->m_CustomItemViewEquipment[2] = GetPrivateProfileInt(section, "CustomItemViewEquipmentSwitch_AL2", 0, path);

	this->m_CustomItemViewEquipment[3] = GetPrivateProfileInt(section, "CustomItemViewEquipmentSwitch_AL3", 0, path);
}
...
void CServerInfo::ReadEventInfo(char* section,char* path) // OK
{
	...
	this->m_CastleSiegeGetCrownAssistantGuildMaster = GetPrivateProfileInt(section, "CastleSiegeGetCrownAssistantGuildMaster", 0, path);
...
void CServerInfo::ReadSkillInfo(char* section,char* path) // OK
{
	...
	this->DisableTwistingSlashDamagePVP = GetPrivateProfileInt(section,"DisableTwistingSlashDamagePVP",0,path);

	this->DisablePowerSlashDamagePVP = GetPrivateProfileInt(section,"DisablePowerSlashDamagePVP",0,path);
