...
struct SDHP_CHARACTER_BLOCCHAT_SEND
{
	PSBMSG_HEAD header;
	WORD	index;
	char	Name[11];
...
struct SDHP_CHARACTER_INFOEQUIP_RECV
{
	PSBMSG_HEAD header;
	WORD	index;
	char	Name[11];
...
void GDSaveBlocChatRecv(SDHP_CHARACTER_BLOCCHAT_SEND* lpMsg);
void GDSaveInfoItemViewRecv(SDHP_CHARACTER_INFOEQUIP_RECV* lpMsg);
