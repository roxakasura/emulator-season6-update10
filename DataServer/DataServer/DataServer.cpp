...
int APIENTRY WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nCmdShow) // OK
{
	...
	wsprintf(buff,"[%s] %s DataServer (QueueSize : %d)",DATASERVER_VERSION,DATASERVER_CLIENT1,0);
	...
	if(WSAStartup(MAKEWORD(2,2),&wsa) == 0)
	{
		...
		// Jewel Bank
		GetPrivateProfileString("JewelsBank","JewelsBankTable","CustomJewelBank",gCashShop.BankExTable,sizeof(gCashShop.BankExTable),".\\DataServer.ini");

		GetPrivateProfileString("JewelsBank","JewelsBankAccount","AccountID",gCashShop.BankExAccount,sizeof(gCashShop.BankExAccount),".\\DataServer.ini");
