...
namespace MuEditor
{
	public class frmUser : frmBase
	{
		...
		private void bind()
		{
			string str = "SELECT DISTINCT {0} AS {0}, {1}[stat].[ConnectStat] AS [Status], {2} AS [{2}], [stat].[IP], [AC].[GameID1] AS [ID1], [AC].[GameID2] AS [ID2], [AC].[GameID3] AS [ID3], [AC].[GameID4] AS ID4], [AC].[GameID5], [AC].[GameID6], [AC].[GameID7], [AC].[GameID8], [AC].[GameID9], [AC].[GameID10] AS [ID5] FROM {3} {4} ORDER BY {0}";
			string str1 = "";
			try
			{
