...
BOOL CCustomJewel::CheckCustomJewelApplyItem(int ItemIndex, int TargetItemIndex) // OK
{
	...
	if(TargetItemIndex <= GET_ITEM(13,212) && TargetItemIndex >= GET_ITEM(13,511))
	{
		return 0;
	}
